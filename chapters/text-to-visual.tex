...
%The \ttv{} models we explore include (i) a relatively simple regressor network relying on a bag-of-words representation for the textual descriptors, (ii) a deep recurrent network that is sensible to word order, and (iii) a wide and deep model that combines a stacked LSTM deep network with a wide regressor network.
...
\toprule
 & \multicolumn{5}{c}{1K samples} & \multicolumn{5}{c}{5K samples} \\
...
\begin{tabularx}{\linewidth}{lRRRRRRR}
  \toprule
  & \multicolumn{3}{c}{Textual search space}        & \multicolumn{3}{c}{Visual search space}                                       &           \\
    \cmidrule(lr){2-4}                   \cmidrule(lr){5-7}
  Method               & \multicolumn{1}{c}{CapRouge}       & \multicolumn{1}{c}{CapBoW}         & \multicolumn{1}{c}{CapGram}        & \multicolumn{1}{c}{pool5}     & \multicolumn{1}{c}{fc6}            & \multicolumn{1}{c}{fc7}            & \multicolumn{1}{c}{\# params}          \\
  \midrule
