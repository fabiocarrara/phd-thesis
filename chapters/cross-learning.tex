...
In the next chapter, we instead investigate an intrinsic limitation of classifiers based on deep neural network, that is its reduced robustness to out-of-distribution inputs.
We explore solutions to increase models' robustness and test them in the context of adversarial attacks, in which a malicious user tries to exploit this vulnerability to fool the classifier.
