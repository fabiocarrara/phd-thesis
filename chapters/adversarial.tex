...
% \todo{REV\#1: The features extracted have a rather high dimension. Are there potentially problems (e.g. curse of dimensionality) with KNN? Is that the reason why the PCA-based version performs better?}
...
\centering
\begin{tabularx}{\linewidth}{XXRRRRR}
\toprule
\textsc{Layer} & \textsc{Processing}                                           & \textsc{Score}  & \sloppy\textsc{L-BFGS}  &  \textsc{FGSM}  & \textsc{Aggr.} & \textsc{Errors} \\
\midrule
\multirow{9}{*}{pool5} & \multirow{3}{*}{None}                                         &    kNN &   70.7          & 69.9          &     70.3          &   58.1 \\
                       &                                                               &  W-kNN &   71.2          & 70.8          &     71.0          &   59.6 \\
                       &                                                               & DW-kNN &   71.0          & 69.9          &     70.4          &   58.6 \\ \cmidrule(l){2-7}
                       & \multirow{3}{*}{L2Norm}                                       &    kNN &   79.2          & 74.3          &     76.7          &   60.7 \\
                       &                                                               &  W-kNN &   81.4          & 76.4          &     78.9          &   62.9 \\
                       &                                                               & DW-kNN &   81.7          & 76.6          &     79.1          &   61.6 \\ \cmidrule(l){2-7}
                       & \multirow{3}{*}{\parbox[c][1.2cm]{1.5cm}{PCA\\+ Whiten}}        &    kNN &   86.4          & 83.4          &     84.9          &   62.9 \\
                       &                                                               &  W-kNN &   85.9          & \textbf{83.8} &     84.8          &   \textbf{65.0} \\
                       &                                                               & DW-kNN &   \textbf{86.5} & 83.5          &     \textbf{85.0} &   63.6 \\
\midrule
\multirow{9}{*}{fc6}   & \multirow{3}{*}{None}                                         &    kNN &   76.4          & \textbf{88.8} &  \textbf{82.2} &   65.8          \\
                       &                                                               &  W-kNN &   \textbf{77.0} & 86.9          &  81.7          &   68.0          \\
                       &                                                               & DW-kNN &   76.3          & 88.6          &  82.0          &   65.2          \\ \cmidrule(l){2-7}
                       & \multirow{3}{*}{L2Norm}                                       &    kNN &   69.6          & 84.9          &  76.5          &   65.6          \\
                       &                                                               &  W-kNN &   70.2          & 86.8          &  77.7          &   71.3          \\
                       &                                                               & DW-kNN &   69.4          & 84.7          &  76.3          &   65.4          \\ \cmidrule(l){2-7}
                       & \multirow{3}{*}{\parbox[c][1.2cm]{1.5cm}{PCA\,+ Whiten}}        &    kNN &   67.5          & 84.8          &  75.2          &   66.2          \\
                       &                                                               &  W-kNN &   68.6          & 86.6          &  76.6          &   \textbf{72.0} \\
                       &                                                               & DW-kNN &   67.9          & 84.4          &  75.3          &   66.0          \\
\midrule
\multirow{9}{*}{fc7}   & \multirow{3}{*}{None}                                         &    kNN &   \textbf{77.0} & 87.8          &  \textbf{82.1} & 67.0          \\
                       &                                                               &  W-kNN &   73.2          & \textbf{88.8} &  80.3          & 69.7          \\
                       &                                                               & DW-kNN &   76.7          & 87.8          &  81.9          & 66.7          \\ \cmidrule(l){2-7}
                       & \multirow{3}{*}{L2Norm}                                       &    kNN &   64.7          & 86.2          &  73.9          & 64.7          \\
                       &                                                               &  W-kNN &   64.1          & 87.8          &  74.1          & 69.9          \\
                       &                                                               & DW-kNN &   64.7          & 86.1          &  73.9          & 64.8          \\ \cmidrule(l){2-7}
                       & \multirow{3}{*}{\parbox[c][1.2cm]{1.5cm}{PCA\,+ Whiten}}        &    kNN &   63.4          & 86.3          &  73.1          & 64.6          \\
                       &                                                               &  W-kNN &   62.7          & 88.0          &  73.2          & \textbf{70.5} \\
...
\bottomrule
\end{tabularx}
\caption{\blue{Examples of good detections of adversarial images with content that might be filtered. Low scores reflect a low confidence of image authenticity.}\\[2ex]}
...
\toprule
\textsc{Score}           & \textsc{Layer} &  \textsc{FGSM} &  \textsc{I-FGSM} &  \textsc{Aggr.} &  \textsc{Errors} \\
\midrule
\multirow{12}{*}{kNN}    & maxpool\_5a\_3x3 &                    50.1 &                                   51.9 &            51.1 &             31.1 \\
                         & mixed\_5b        &                    53.0 &                                   54.4 &            53.8 &             35.4 \\
                         & mixed\_5c        &                    56.6 &                                   58.4 &            57.6 &             41.2 \\
                         & mixed\_5d        &                    57.6 &                                   59.8 &            58.9 &             43.2 \\
                         & mixed\_6a        &                    62.6 &                                   65.7 &            64.4 &             51.5 \\
                         & mixed\_6b        &                    62.3 &                                   72.7 &            68.2 &             52.8 \\
                         & mixed\_6c        &                    70.7 &                                   80.6 &            76.3 &             60.5 \\
                         & mixed\_6d        &                    70.9 &                          \textbf{83.0} &   \textbf{77.8} &             64.5 \\
                         & mixed\_6e        &                    72.5 &                                   74.2 &            73.5 &             71.3 \\
                         & mixed\_7a        &                    73.0 &                                   77.2 &            75.4 &             71.4 \\
                         & mixed\_7b        &                    73.7 &                                   70.5 &            71.9 &             75.2 \\
                         & mixed\_7c        &           \textbf{74.0} &                                   52.0 &            61.5 &    \textbf{78.5} \\
\midrule
\multirow{12}{*}{W-kNN}  & maxpool\_5a\_3x3 &                    58.2 &                                   60.8 &            59.7 &             45.6 \\
                         & mixed\_5b       &                    59.5 &                                   63.0 &            61.5 &             49.1 \\
                         & mixed\_5c       &                    62.2 &                                   66.9 &            64.9 &             54.6 \\
                         & mixed\_5d       &                    63.8 &                                   68.7 &            66.6 &             57.5 \\
                         & mixed\_6a       &                    68.7 &                                   74.4 &            72.0 &             61.7 \\
                         & mixed\_6b       &                    67.8 &                                   79.9 &            74.7 &             63.1 \\
                         & mixed\_6c       &                    71.0 &                                   82.5 &            77.6 &             68.2 \\
                         & mixed\_6d       &                    71.7 &                          \textbf{84.6} &   \textbf{79.1} &             69.4 \\
                         & mixed\_6e       &                    74.3 &                                   75.6 &            75.1 &             72.1 \\
                         & mixed\_7a       &           \textbf{75.5} &                                   78.4 &            77.2 &             75.0 \\
                         & mixed\_7b       &                    75.1 &                                   71.3 &            72.9 &             76.5 \\
                         & mixed\_7c       &                    74.4 &                                   52.3 &            61.9 &    \textbf{80.5} \\

\midrule
\multirow{12}{*}{DW-kNN} & maxpool\_5a\_3x3 &                    58.3 &                                   60.9 &            59.8 &             45.7 \\
                         & mixed\_5b       &                    59.5 &                                   63.0 &            61.5 &             49.1 \\
                         & mixed\_5c       &                    62.2 &                                   66.9 &            64.9 &             54.5 \\
                         & mixed\_5d       &                    63.8 &                                   68.8 &            66.6 &             57.8 \\
                         & mixed\_6a       &                    68.8 &                                   74.4 &            72.0 &             62.7 \\
                         & mixed\_6b       &                    68.0 &                                   80.0 &            74.8 &             64.0 \\
                         & mixed\_6c       &                    71.4 &                                   82.3 &            77.6 &             69.2 \\
                         & mixed\_6d       &                    71.6 &                          \textbf{85.0} &   \textbf{79.2} &             69.5 \\
                         & mixed\_6e       &                    72.8 &                                   75.5 &            74.4 &             72.6 \\
                         & mixed\_7a       &                    74.4 &                                   78.3 &            76.7 &             73.1 \\
                         & mixed\_7b       &                    74.4 &                                   71.4 &            72.7 &             76.1 \\
                         & mixed\_7c       &           \textbf{74.5} &                                   52.8 &            62.2 &    \textbf{79.0} \\
\bottomrule
\end{tabularx}
...
\end{subfigure}%
%
\caption{True positive and false positive rates when varying the score threshold. The scores are computed using \textbf{\emph{mixed\_6d}} (on the left) and \textbf{\emph{mixed\_7a}} (on the right) of the InceptionV3 classifier. DW-kNN scoring scheme was selected for both.}
...
% \todo{Rivedere conclusioni alla luce dei nuovi esperimenti su InceptionV3}
