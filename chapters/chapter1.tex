...
\section{Another section}
	\subsection{And a subsection}
		In this sub section I will include many images just to make the list of figures meaningful.
			...
			\begin{figure}[h!tb]
				\centerline {\includegraphics[scale=0.6]{img/unipi.png}}
...
Please define the notation at the beginning, defining operators and symbols in \textit{Notation} file, such as \gls{matrix_channel}, \gls{trasp_x}, \gls{vec_x}, \gls{floor_funct}.