...
The idea behind our \gls{sq} approach is to map the real-valued vector components independently into a smaller set of integer values which act as the term frequencies of a predefined set of codewords.
...
To achieve this we propose two ways: keep the top-$k$ larger components of the vector or maintain components above a certain threshold $\sfrac{1}{\gamma}$ by zeroing all the others.
...
Another important aspect of our approach is its completely independence from the technology used for indexing.
