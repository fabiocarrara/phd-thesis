...
Search engines on the Web have in the past achieved significant results in terms of efficiency thanks to the use of inverted index technology.
...
However, since 2014, new features learned by \acrlong{dl} --- in particular, \acrlongpl{cnn} --- guided a significant development in this field and hugely mitigate the semantic gap problem.
