...
Each class has roughly 1,000 images in the training set (the number oscillates between 900 and 1,300), and exactly 50 images in both the validation and test set, for a total of XXX images for the train set, 50,000 in the validation set, and 50,000 in the test set.
