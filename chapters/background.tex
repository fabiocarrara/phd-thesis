...
% TODO [CITE] VO/SLAM/SfM w/ LF
However, manually engineered solutions are feasible for very specific problems -- such as image stitching~\cite{brown2007automatic} -- where the conditions are well known and modelled.
