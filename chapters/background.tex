...
\begin{figure}
    \asyinclude[inline, width=\linewidth]{figures/activations.asy}
...
\begin{figure}
    \centering
    \asyinclude[inline,width=.9\linewidth]{figures/rnn.asy}
...
\begin{figure}
    \centering
    \asyinclude[inline,width=.9\linewidth]{figures/bidir-rnn.asy}
...
\begin{figure}
    \centering
    \asyinclude[inline, width=\linewidth]{figures/lstm.asy}
