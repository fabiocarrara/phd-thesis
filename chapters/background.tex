...
% TODO [CITE] dropout, then probably move to regularization section
...
We indicate as \acrfull{cbir} the task of retrieving from a (potentially large) collection of images the ones relevant to a user query by looking only to their unstructured content, i.e. without exploiting additional information associated with images such as textual annotations or structured metadata as traditional approach would.
...
the system does not know whether the user wants to retrieval images containing a at least a dog, a dog of that particular breed, or other pictures of the same park.
...
% TODO add TDCG from "picture it" paper tex
...
%medR
\paragraph{\acrlong{medR}}
The \acrfull{medR} is ...
% MRR
\paragraph{\acrlong{mrr}}
The \acrfull{mrr} is ...
