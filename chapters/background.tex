...
...
They finally proposes deeper architectures comprised by 10+ layers;
in this work, we will refer to the 16-layer and 19-layer architectures respectively as \gls{vgg}-16 and \gls{vgg}-19.
...
The \gls{ilsvrc}12 dataset is a large set of labelled images containing general objects collected for evaluating algorithms for large-scale visual object recognition.
...
Images in \gls{ilsvrc}12 are single-labelled with one of 1,000 classes selected for the competition.
% Train/dev..
